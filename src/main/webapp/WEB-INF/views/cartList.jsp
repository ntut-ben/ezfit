	...
	<div id="main">
		<div class="container bg-white my-5">
          ...
          <div class="col-12 my-2 ">
			...
			<form action="http://localhost:8080/ezfit/api/shopCart/bill" method="POST"
						...
						<div class="container">
							...
							<span class="my-2 d-flex">
								...
								<button id="clickBtn" type="button"
									class="btn btn-success ml-auto">同購買人資料</button>
							</span>
							<!-- 手機號碼 -->
							<span class="my-2 d-flex">
								<div class="w-5">
							...
							<span class="my-2 d-flex">
								<div class="w-5">
									<label for="address" style="visibility: hidden;">住址 </label>
								</div>
								<div class="w-100">
