					...
					<div class="cotainer-fulid">
						<div class="row justify-content-between">
							<div class="col-8 d-flex flex-column justify-content-end">
								<div class="my-1">
									<form action="">
										<input type="text" name="search" class="serarchBarInput" />
									...
									<div class="container-fulid">
										<div class="row">
											...
											<div id="groupDeadLine" class="col-12 my-1 h6">
												團購結單日期：2019-12-02</div>
											<div class="col-12 my-1 d-flex">
												<div>
													<button id="groupShareBtn"
														class="btn btn-success text-white">揪朋友</button>
												</div>
												<div class="mx-auto">
													<button id="orderMGT" class="btn btn-success text-white ">
														訂單管理</button>
												</div>
											</div>
										</div>
			...
			<div class="row">
				...
				<div id="menu" class="col-2 mx-auto " style="max-height: 100vh">
					<div class="container">
						...
						<ul class="mx-auto">
							<li class="m-3"><a class="selectCate" href=""
								data-category="vegetable" data-page="1">蔬菜</a></li>
							<li class="m-3"><a class="selectCate" href=""
								data-category="fruit" data-page="1">水果</a></li>
							<li class="m-3"><a class="selectCate" href=""
								data-category="brute" data-page="1">牛羊豬肉</a></li>
							<li class="m-3"><a class="selectCate" href=""
								data-category="poultry" data-page="1">雞鴨鵝肉</a></li>
							<li class="m-3"><a href="" class="selectCate" href=""
								data-category="seafood" data-page="1">魚蝦海鮮</a></li>
							<li class="m-3"><a href="" class="selectCate" href=""
								data-category="rice" data-page="1">米麵雜糧</a></li>
							<li class="m-3"><a href="" class="selectCate" href=""
								data-category="egg" data-page="1">蛋奶豆製品</a></li>
						</ul>
					</div>
				</div>
                    ...
                    <div class="card-body p-0">
							...
							<div class="col-12">
								<nav aria-label="Page navigation example">
									<ul id="page" class="pagination justify-content-center">
										<li id="pagePrevious" class="page-item"><a
                      ...
                      <li class="page-item">
                        ...
                        >
										...
										<li id="pageNext" class="page-item disabled"><a
