					...
					<div class="container">
						...
						<ul class="mx-auto">
							<li class="m-3"><a class="selectCate" href=""
								data-category="vegetable" data-page="1">蔬菜</a>
							</li>
							<li class="m-3"><a class="selectCate" href=""
								data-category="fruit" data-page="1">水果</a>
							</li>
							<li class="m-3"><a class="selectCate" href=""
								data-category="brute" data-page="1">牛羊豬肉</a>
							</li>
							<li class="m-3"><a class="selectCate" href=""
								data-category="poultry" data-page="1">雞鴨鵝肉</a>
							</li>
							<li class="m-3"><a href="" class="selectCate" href=""
								data-category="seafood" data-page="1">魚蝦海鮮</a>
							</li>
							<li class="m-3"><a href="" class="selectCate" href=""
								data-category="rice" data-page="1">米麵雜糧</a>
							</li>
							<li class="m-3"><a href="" class="selectCate" href=""
								data-category="egg" data-page="1">蛋奶豆製品</a>
							</li>
						</ul>
					</div>
				</div>
