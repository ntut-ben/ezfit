...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/groupBuying_main.css" />
<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
<title>Group Buying</title>
<script type="text/javascript">
	errorName = "${MsgErr.errorName}";
	errorPhone = "${MsgErr.errorPhone}";
	errorAddress = "${MsgErr.errorAddress}";
	errorGroupName = "${MsgErr.errorGroupName}";
</script>
</head>
<body>
	<!--   Header -->
	...
	<div id="mainContainer" class="container-fulid"
		...
		<div id="mainBody" class=" p-5 my-auto w-50"
			style="position: absolute; left: 25%; top: 18%; background: rgba(255, 255, 255, 0.8);"></div>
	</div>
	...
	<script src="${pageContext.request.contextPath}/js/groupBuying_new.js"></script>
</body>
</html>
