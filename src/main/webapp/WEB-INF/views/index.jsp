<%-- Version: eDMo 新增功能: (1)維護書籍資料的功能全部改為Annotation
(2)存取資料庫的功能全部改為介面 --%> <%@ page language="java"
...
<html>
  ...
  <body>
            ...
            <div class="col-xl-6 col-sm-12">
              <div class="intro-text-bg">
                <div class="intro-text">
                  ...
                  <h4>你也可以成為一個料理網紅！</h4>
                  <p>
                    尋找平台記錄自己的私房料理嗎？這邊有愛好下廚、做菜的網友們分享超過
                    60000
                    篇食譜任您免費瀏覽和收藏食譜，還可料理直播！歡迎加入這個的廚藝社群，一起天天享受烹飪。
                  </p>
                  <br />
                  <h4>食材打包功能</h4>
                  <p>
          ...
          <div class="modal-body">
            <div class="form-group">
              <div class="form-group row mb-2">
                <label for="inputSex" class="col-sm-2 col-form-label"
                  >性別</label
                >
                <div class="col-8">
              ...
              <div class="form-group row mb-2">
                <label for="inputHeight" class="col-sm-2 col-form-label text-sm"
                  >身高</label
                >
              ...
              <div class="form-group row mb-2">
                ...
                <div class="col-8">
                  <select class="custom-select mr-sm-2" id="exercise">
                    ...
                    <option value="1.55"
                      >中度活動 (每週中等強度運動3~5天)</option
                    >
                    <option value="1.725"
                      >高度活動 (每週高等強度運動6~7天)</option
                    >
                    <option value="1.9"
                      >非常高度度活動 (勞力密集工作或每天訓練)</option
                    >
                  </select>
                </div>
              </div>
    ...
    <div class="toast ">
      <div class="toast-header bg-info text-white">123</div>
      <div class="toast-body">312</div>
    </div>
