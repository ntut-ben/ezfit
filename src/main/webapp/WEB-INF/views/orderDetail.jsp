...
<body>
	...
	<div id="main">
		<div class="container my-4">
			<div class="text-center my-4" id="orderInfo">
				張君雅，訂購成功!您的訂單編號為#12345678</div>

			<div id="cartListRow" class="row bg-white">
				<div class="col-12 my-2">購物明細</div>
				<div class="col-2 my-3" id="orderId">訂單編號: #12345678</div>
				<div class="col-3 my-3" id="orderTime">時間： 2019/10/18 星期五
					10:19:35</div>
			...
			<div class="col-12 text-right my-4 cartCard">
				<a href="shopMaterial.html"><u>回商城繼續購物</u></a>
			</div>
		</div>
	</div>
	<!-- Footer -->
