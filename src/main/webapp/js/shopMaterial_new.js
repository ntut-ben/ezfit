$(document).ready(function() {
  ...
  function getData() {
    ...
    $.ajax({
      type: "get",
      url: `http://localhost:8080/ezfit/ListIngredient.do?category=${category}`,
      ...
      complete: function(xhr) {
        ...
        if (xhr.status == 200) {
          ...
          $(".popupCard").click(function(e) {
            ...
            $.ajax({
              type: "GET",
              url: `http://localhost:8080/ezfit/ListIngredient.do?itemId=${itemId}`,
              dataType: "json",
...
<div class="row">
  ...
  <div class="col-8 mx-auto">
    ...
    <form action="http://localhost:8080/ezfit/ShopCart.do" method="POST" class="text-right ">
    <input type="text" name="action" value="add" style="display: none;"/>
    <input type="text" name="category" value="IngredientProduct" style="display: none;"/>
